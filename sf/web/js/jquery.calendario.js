    ...
    $.Calendario.prototype = {
        ...
        _processCaldataObj: function (val, key) {
          if (typeof val !== 'object') {
            val = {content: val, startTime: '00:00', endTime: '23:59', allDay: true};
          }
          if (!val.content) {
          ...
          if (!val.startTime && !val.endTime) {
            val = $.extend({}, val, {startTime: '00:00', endTime: '23:59', allDay: true});
          }
        ...
        _propDate: function ($cell, event) {
            var idx = $cell.index(),
                ...
                dateProp.date = $.datepicker.formatDate("mm-dd-yy", new Date(dateProp.monthname + ' ' + dateProp.day + ',' + dateProp.year));
